...
public class TypeTemplateController {
	...
	@RequestMapping("select2TypeNameList")
	public List<Map> select2TypeNameList(){
		return typeTemplateService.select2TypeNameList();
	};
	...
	public PageResult search(@RequestBody(required = false) TbTypeTemplate typeTemplate, int page, int rows  ){
