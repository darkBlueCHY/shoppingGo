...
import com.CHY.shoppingGo.po.TbItemExample.Criteria;
...
public class ItemServiceImpl implements ItemService {
	...
	@Override
	public List<TbItem> findItemByGoodsId(List<Long> ids,String goodsAuditStatus) {
		if ("1".equals(goodsAuditStatus)) {
			TbItemExample example = new TbItemExample();
			//这个1表示商品上架  与上面1表示审核通过不同！
			example.or().andGoodsIdIn(ids).andStatusEqualTo("1");
